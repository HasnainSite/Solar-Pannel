        ...
        {onViewAllProducts && (
          <div className="pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#6D28D9] hover:bg-[#5B21B6] text-white font-extrabold px-5 py-2.5 rounded-xl text-xs shadow-md transition-all hover:scale-105 shadow-purple-900/20"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2 rounded-xl text-xs font-medium border focus:outline-none focus:ring-2 focus:ring-[#6D28D9] transition-all ${
      ...
      {filteredProducts.length === 0 ? (
        <div className="text-center py-16 bg-slate-50 dark:bg-slate-900 rounded-3xl border border-dashed border-slate-300 dark:border-slate-800">
          ...
          <button
            ...
            className="mt-3 text-xs font-bold text-[#6D28D9] dark:text-purple-400 hover:underline"
          >
            Reset Filters
          </button>
        </div>
            ...
            >
              <div>
                ...
                <div className="p-5 space-y-3">
                  <div className="flex items-center justify-between text-xs text-slate-400 font-medium">
                    <span className="capitalize text-[#6D28D9] dark:text-purple-400 font-extrabold">{prod.category}</span>
                  ...
                  <h3 className="text-base font-bold tracking-tight line-clamp-1 group-hover:text-[#6D28D9] dark:group-hover:text-purple-400 transition-colors">
                    {prod.name}
                  </h3>
              ...
              <div className="p-5 pt-0 flex gap-2">
                ...
                <button
                  ...
                  className="bg-[#6D28D9] hover:bg-[#5B21B6] text-white px-4 py-2.5 rounded-xl text-xs font-bold shadow-md transition-all flex items-center gap-1 shadow-purple-900/20"
                >
                  <span>Quote</span>
